...
def createAplication(loggin):
  ...
  if( label2.cget("text")==""):
    ...
    bandera=False
  if(bandera):
    if(createAplicationIIS(Textboxb.get(),label2.cget("text"),loggin)):tk.messagebox.showinfo(title="Felicidades", message="La aplicacion se creo correctamente")
...
menu.title("Instalador de servicios Unicos V0.98.9")
...
button8 = tk.Button(frame, text="Configurador de citas", command=lambda: show_frame(frame,frame5)).place(x=2.5,y=270)
...
button8 = tk.Button(frame2, text="Configurador de citas", command=lambda: show_frame(frame2,frame5)).place(x=2.5,y=270)
...
button8 = tk.Button(frame3, text="Configurador de citas", command=lambda: show_frame(frame3,frame5)).place(x=2.5,y=270)
...
button8 = tk.Button(frame4, text="Configurador de citas", command=lambda: show_frame(frame4,frame5)).place(x=2.5,y=270)
...
# Widgets para el frame2
button2 = tk.Button(frame5, text="Instalador de servicio", command=lambda: show_frame(frame5,frame)).place(x=275,y=240)
button5 = tk.Button(frame5, text="Creador de aplicaciones", command=lambda: show_frame(frame5,frame2)).place(x=275,y=270)
button7 = tk.Button(frame5, text="Configurador UDLS", command=lambda: show_frame(frame5,frame3)).place(x=145,y=270)
button9 = tk.Button(frame5, text="Modificador de puertos", command=lambda: show_frame(frame5,frame4)).place(x=2.5,y=270)
button6 = tk.Button(frame5, text="",image=confImg ,command=lambda: show_frame(frame5,frameC)).place(x=375,y=40)
...
labelColor1.place(x=10,y=70)
labelColor1 = tk.Label(frameC,text="Color frame 2",bg=colorframeC)
labelColor1.place(x=10,y=110)
labelColor1 = tk.Label(frameC,text="Color frame 3",bg=colorframeC)
labelColor1.place(x=10,y=150)
labelColor1 = tk.Label(frameC,text="Color frame 4",bg=colorframeC)
labelColor1.place(x=10,y=190)
labelColor1 = tk.Label(frameC,text="Color frame 5",bg=colorframeC)
labelColor1.place(x=10,y=230)
...
comboBoxColo5 = OptionMenu(frameC, variableColor5, *OPTIONS)
